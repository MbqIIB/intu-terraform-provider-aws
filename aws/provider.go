...
func Provider() terraform.ResourceProvider {
	...
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"aws_servicecatalog_product_association":                  resourceAwsServiceCatalogProductAssociation(),
			"aws_servicecatalog_principal_association_portfolio":      resourceAwsServiceCatalogPrincipalAssociationPortfolio(),
			"intu_aws_servicecatalog_constraint":                      resourceAwsServiceCatalogConstraint(),
			"intu_aws_servicecatalog_portfolio":                       resourceAwsServiceCatalogPortfolio(),
			"intu_aws_servicecatalog_product":                         resourceAwsServiceCatalogProduct(),
			"intu_aws_servicecatalog_product_association":             resourceAwsServiceCatalogProductAssociation(),
			"intu_aws_servicecatalog_principal_association_portfolio": resourceAwsServiceCatalogPrincipalAssociationPortfolio(),
